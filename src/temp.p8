    ...
    if(player.task == "suit") then  --if current task is searching for suit then sees in what part of the clues he is in
            if(player.currentclue == 1) then
                if (game.text == "main wardrobe" and fget(103, 7)) then
        				cls()
        				sfx(25)
            		display_text("quit toying around! i gotta get to work!", 10, 90, 110, 150)
        				wait(50)
            		fset(103,7,false)
            ...
            elseif(player.currentclue == 2) then
            	if (game.text == "teddy bear" and fget(226, 7)) then
        				cls()
        				sfx(23)
            		display_text("you pick up a key behind the teddy bear! what could this open?", camx, camy, camx + 128, camy + 128)
        				wait(75)
            		fset(206,7,false)
            ...
            elseif(player.currentclue == 3) then
                 if (game.text == "kids wardrobe" and fget(79, 7)) then
        				cls()
        				music(11)
            		display_text("you now have your suit! ask your wife what's missing!", 10, 90, 110, 150)
        				wait(50)
            		fset(206,7,false)
        ...
        elseif(player.task == "suitcase") then  --if current task is searching for suit then sees in what part of the clues he is in
            if(player.currentclue == 1) then
               if (game.text == "bed") then
        				cls()
        				sfx(33)
            		display_text("hmm, your case? you were with it in the bathroom for some reason", 10, 90, 110, 150)
                wait(50)
            ...
            elseif(player.currentclue == 2) then
            	if (game.text == "toilet" and (fget(224, 7) or fget(225, 7) or fget(240, 7) or fget(241, 7) )) then
        				cls()
        				sfx(25)
            		display_text("i gotta keep my cool", 10, 90, 110, 150)
                wait(50)
            ...
            elseif(player.currentclue == 3) then
            	if (game.text == "fridge" and fget(39, 7)) then
        				cls()
        				music(11)
            		display_text("you have found your suitcase! ask your wife what's next!", 10, 90, 110, 150)
                wait(50)
         ...
         elseif(player.task == "papers") then  --if current task is searching for suit then sees in what part of the clues he is in
            if(player.currentclue == 1) then
                if (game.text == "bed") then
        				sfx(33)
            		display_text("how should i know where you left the report? it should be in your case", 30, 140, 150, 150)
            ...
            elseif(player.currentclue == 2) then
      					sfx(25)
            		display_text("nom nom nom", 30, 14, 150, 150)
            		player.currentclue = 3
            elseif(player.currentclue == 3) then
                if (game.text == "dining table" and (fget(141, 7) or fget(112, 7) or fget(101, 7)) ) then
        				music(11)
            		display_text("you have found your suitcase! ask your wife what's next!", 30, 140, 150, 150)
            		fset(141, 7, false)
            		fset(112, 7, false)
            		fset(101, 7, false)
        ...
        elseif(player.task == "keys") then  --if current task is searching for suit then sees in what part of the clues he is in
            if(player.currentclue == 1) then
                 if (game.text == "bed") then
        				sfx(33)
            		display_text("i'm sick of all your questions. go to where you can breathe the easiest indoors to find your keys", 30, 140, 150, 150)
            ...
            elseif(player.currentclue == 2) then
                if (game.text == "vase" and (fget(195, 7) or fget(196, 7) or fget(211, 7) or fget(212,7))) then
                  music(11)
                	display_text("you have found the last item you needed to leave your house: your keys! good job!", 30, 140, 150, 150)
...
function draw_player()
        ...
        spr(206,player.x,player.y-4)
    		spr(207,player.x+8,player.y-4)
    		spr(222,player.x,player.y+4)
    		spr(223,player.x+8,player.y+4)
    ...
    elseif was_pressed and player.direction == 3 then
    	spr(204,player.x,player.y+4, 1, 1, false, true)
    	spr(205,player.x+8,player.y+4, 1, 1, false, true)
    	spr(220,player.x,player.y-4, 1, 1, false, true)
    	spr(221,player.x+8,player.y-4, 1, 1, false, true)
    elseif was_pressed and player.direction == 2 then
    	spr(204,player.x,player.y-4)
    	spr(205,player.x+8,player.y-4)
    	spr(220,player.x,player.y+4)
    	spr(221,player.x+8,player.y+4)
    elseif not(was_pressed) and player.direction == 1 then
    	spr(202,player.x+4,player.y-4)
    	spr(218,player.x+4,player.y+4)
    elseif not(was_pressed) and player.direction == 0 then
    	spr(202,player.x-4,player.y-4, 1, 1, true, false)
    	spr(218,player.x-4,player.y+4, 1, 1, true, false)
    elseif not(was_pressed) and player.direction == 2 then
    	spr(234,player.x-4,player.y+4)
    	spr(235,player.x+4,player.y+4)
    else
    	spr(234,player.x-4,player.y+4, 1, 1, false, true)
    	spr(235,player.x+4,player.y+4, 1, 1, false, true)
    end
end
    ...
    function moveloop()
        ...
        if move() then
            for i = 1, count(all_sprites) do
                ...
                player.x_acc = -player.x_acc/2
                player.y_acc = -player.y_acc/2
...

...

__map__
...

